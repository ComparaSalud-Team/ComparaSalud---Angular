...
// Página de detalle de una cita puntual (/mis-citas/:id). Desde acá el
// paciente puede ver la información completa de la cita, cancelarla o
// reagendarla (eligiendo un nuevo horario dentro de la disponibilidad real
// del proveedor, vía GET /api/providers/{id}/availability).
@Component({
  ...
  confirmarReagendar(): void {
    ...
    this.citasService
      .reprogramarCita(this.appointmentId, {
        ...
        // No usar slot.endTime: el backend genera bloques genéricos de 1h,
        // pero la cita solo debe durar lo que dura la consulta real del
        // médico (cita.durationMinutes), igual que en agendar-cita.ts.
