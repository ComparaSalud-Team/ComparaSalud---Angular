...
export class DashboardComponent implements OnInit {
  ...
  // distritos reales de /api/providers, y al buscar navega a /busqueda-paciente
  // con esos criterios como query params.
  busquedaRapida = {
    especialidad: '',
    ubicacion: '',
    fecha: '',
  ...
  iconoServicio(servicio: MedicalService): string {
    ...
    const match = this.iconosPorPalabraClaveServicio.find((entry) =>
      nombre.includes(entry.keyword),
    );
